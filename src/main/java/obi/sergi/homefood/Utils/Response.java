...
public class Response {
    ...
    public static final String USER_EXISTS = "User already exists", USER_DO_NOT_EXIST = "User do not exist";
    ...
    public static final String ITEM_LOCATION_EXISTS = "Item location already exists";
